...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    IGoogleApi mService;
    private final LatLng epn = new LatLng(-0.210370,  -78.489120);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final LatLng comite = new LatLng(-0.1469637549154851, -78.49009966499239);
        mMap.addMarker(new MarkerOptions().position(comite).title("Quicentro Shopping"));
        final LatLng cato = new LatLng(-0.208739772610497,  -78.49152624607086);
        ...
        .zoom(12).bearing(30).tilt(45).build()));

        listaRutas = new ListView(this);
        String[] ruta= {"Quicentro - 12 de Octubre","Bicentenario - 12 de Octubre","Seminario Mayor - Hospital Militar"};

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.list_rutas,R.id.txtRuta,ruta);
    ...
    private void ruta (LatLng inicio, LatLng fin){
        try{
